...
# dias em atraso e passar estes valores para a função valorPagamento, que calculará o valor a ser pago
# e devolverá este valor ao programa que a chamou. O programa deverá então exibir o valor a ser
# pago na tela. Após a execução o programa deverá voltar a pedir outro valor de prestação e assim
# continuar até que seja informado um valor igual a zero para a prestação. Neste momento o
